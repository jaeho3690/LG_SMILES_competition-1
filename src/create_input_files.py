...
from utils import train_test_split_df,create_input_files,str2bool
from config import data_dir,train_dir,train_csv_dir,train_pickle_dir,input_data_dir,random_seed
...
if __name__ == '__main__':
    ...
    if config['split']==True:
        ...
        train_test_split_df(data_dir=data_dir,
