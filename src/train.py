...
# Data parameters
data_folder = '/home/jaeho_ubuntu/SMILES/data/input_data'  # folder with data files saved by create_input_files.py
data_name = 'seed_123_max75smiles' # base name shared by data files
