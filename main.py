...
parser.add_argument('--emb_dim', type=int, default=32, help='dimension of word embeddings')
parser.add_argument('--attention_dim', type=int, default=32, help='dimension of attention linear layers')
parser.add_argument('--decoder_dim', type=int, default=32, help='dimension of decoder RNN')
